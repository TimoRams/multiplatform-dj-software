...
inline MidiInteractionType defaultInteractionTypeForParam(const QString& paramId)
{
    if (paramId == QStringLiteral("deckA_cue")
        ...
        || paramId.startsWith(QStringLiteral("deckB_keyshift_pad"))
        || paramId.startsWith(QStringLiteral("deckC_keyshift_pad"))
        || paramId.startsWith(QStringLiteral("deckD_keyshift_pad"))
    ...
    if (paramId == QStringLiteral("deckA_play")
        ...
        || paramId.startsWith(QStringLiteral("deckC_pad_mode_"))
        || paramId.startsWith(QStringLiteral("deckD_pad_mode_"))
        || paramId.startsWith(QStringLiteral("deckA_keyshift_range_"))
        || paramId.startsWith(QStringLiteral("deckB_keyshift_range_"))
        || paramId.startsWith(QStringLiteral("deckC_keyshift_range_"))
        ...
        || paramId == QStringLiteral("deckC_keylock")
        || paramId == QStringLiteral("deckD_keylock")
