    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle { Layout.preferredWidth: 5; Layout.fillHeight: true; color: "#111111" }
