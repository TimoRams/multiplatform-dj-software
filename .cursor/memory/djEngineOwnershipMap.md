...
| active reader sources and `readAheadThread` | `DjEngine` playback pipeline | per deck | future DeckAudioGraph | Qt source handover/read-ahead/audio callback lifetime crossover | prepared loader readers, JUCE transport | very high |
