...
int main(int argc, char** argv)
{
    ...
    const auto bassRgb = waveform_visual::map(
        WaveformRenderStyle::SpectralRgb, {0.90f, 0.08f, 0.02f, 0.75f});
    const auto midRgb = waveform_visual::map(
        WaveformRenderStyle::SpectralRgb, {0.04f, 0.90f, 0.06f, 0.75f});
    const auto highRgb = waveform_visual::map(
        WaveformRenderStyle::SpectralRgb, {0.02f, 0.05f, 0.90f, 0.75f});
    ...
    const waveform_render::OverviewRenderKey rgbOverview{
        ...
        static_cast<std::uint8_t>(WaveformRenderStyle::SpectralRgb),
        waveform_visual::revision(WaveformRenderStyle::SpectralRgb)};
